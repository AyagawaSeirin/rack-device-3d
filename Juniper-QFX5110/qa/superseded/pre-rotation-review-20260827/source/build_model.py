...
def build_scene(textures: dict[str, Image.Image]) -> trimesh.Scene:
    ...
    add(
        ...
        front_overlay_group(front_rects, FRONT_Z + 0.00086, front_module_material),
    )
    ...
    add(
        ...
        front_overlay_group(qsfp_rects, FRONT_Z + 0.00086, front_module_material),
    )
    ...
    add(
        ...
        front_overlay_group([(-0.201, 0.0075, 0.0155, 0.0145)], FRONT_Z + 0.00086, front_module_material),
    )
