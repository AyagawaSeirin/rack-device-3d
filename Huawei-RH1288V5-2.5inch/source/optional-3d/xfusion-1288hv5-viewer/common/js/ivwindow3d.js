...
iv.window.prototype._loadCallback=function(info,r)
{
    ...
    else {s.load(JSON.parse(r.responseText));}   //在此修改路径问题，美滋滋
...
iv.window.prototype.pd=function(e){
...
iv.window.prototype.fuzzySearchNode = function(id)
{
	if(this.space && this.space.root)
		return this.space.root.fuzzySearch(id);
	return null;
}
