async (page) => {
  const base='http://127.0.0.1:8876/Huawei-RH1288V5-3.5inch',output='/root/Project/rack-device-3d/Huawei-RH1288V5-3.5inch/qa/rotation-review-20260827/static-40-loads';
  ...
  const models={standard:base+'/model/Huawei-RH1288V5-3.5inch.glb',web:base+'/model/Huawei-RH1288V5-3.5inch-web.glb'};
  ...
  const manifest={device:'Huawei-RH1288V5-3.5inch',phase:'final-static-40-loads',capturedAt:new Date().toISOString(),views:[],loadCount:0};
