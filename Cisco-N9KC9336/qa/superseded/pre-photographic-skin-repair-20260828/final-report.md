...
> **2026-08-27 Task-12 supersession:** the current authoritative report, hashes and browser evidence are in `qa/rotation-review-task12-20260827/FINAL-REPORT.md`. The content below is retained as historical pre-rotation documentation only.
