async (page) => {
  ...
  const model = "../../model/HPE-DL360G9-2.5inch-web.glb", views = ["front-left", "front-right", "rear-left", "rear-right"];
  ...
  return { engine: "Babylon.js", profile: "web", captures: [...views, "front-dark"] };
}
