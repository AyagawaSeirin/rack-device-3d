...
infinityrt_navigation = function (scene, w, h) {
    ...
    this._navMode = 2;
    this._navMinDolly = -30.0;
    this._navMaxDolly = 270.0;
    this._navSpeed = 5.0;
    this._navDecay = 0.25;
    ...
    this._navPanDolly = -290.0;        // Distance when pan changes to rotation
    ...
    this._panMax = [38, 25];    //[right, bottom];
   this._panMin = [-58, -10.5];  //[left, top];
}
    ...
    if (this._navMode == 0 || this._navMode == 2) {
        if (this._navMode == 2) {
            ...
            if (this._navDXAng != 0.0 || this._navDYAng != 0.0 || this._navDPan[0] != 0.0 || this._navDPan[1] != 0.0 || this._navDDolly != 0.0) {
                ...
                dollyfrac=(this._navMaxDolly-this._navDolly)/(this._navMaxDolly-this._navMinDolly);                 
                var pullup=0.;
                ...
                var fRotMinLimit = -dollyfrac*(M_PI*0.01);
