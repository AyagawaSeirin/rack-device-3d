...
P=Path('/root/Blender/DELL-C6420/v001');scene=bpy.context.scene
scene.name='DELL_C6420_4N_24SFF_MASTER'
...
for name in ['build_c6420.py','repair_geometry.py','refine_finish.py','audit_scene.py','export_deliverables.py','prepare_triangles.py']:
