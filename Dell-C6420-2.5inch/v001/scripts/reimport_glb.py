...
P=Path('/root/Blender/DELL-C6420/v001');master=bpy.context.scene
...
qa.render.engine='CYCLES';qa.cycles.device='CPU';qa.cycles.samples=96;qa.cycles.use_denoising=False
qa.render.resolution_x=1400;qa.render.resolution_y=950;qa.render.resolution_percentage=100
qa.view_settings.view_transform='AgX';qa.render.image_settings.file_format='PNG';qa.render.film_transparent=False
qa.eevee.taa_samples=128;qa.eevee.taa_render_samples=128
for a in bpy.context.screen.areas:
 if a.type=='VIEW_3D':
  s=a.spaces.active;s.clip_start=.001;s.clip_end=20;s.shading.type='MATERIAL';s.overlay.show_overlays=False
