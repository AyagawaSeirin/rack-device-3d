...
P=Path('/root/Blender/DELL-C6420/v001');s=bpy.context.scene;flags=[];triangles=0
for o in s.objects:
...
(P/'qa/glb-geometry-audit.json').write_text(json.dumps(r,indent=2));print('GLB geometry flags',len(flags),flags[:8]);print('Opaque shell probes',len(probes),'misses',r['missed_shell_probes'])
