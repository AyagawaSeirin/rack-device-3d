...
P=Path('/root/Project/rack-device-3d/Dell-C6420-2.5inch/v002');s=bpy.context.scene;assert 'GLB_REIMPORT' in s.name
s.render.engine='CYCLES';s.cycles.device='CPU';s.cycles.samples=96;s.cycles.use_denoising=False;s.cycles.use_preview_denoising=False;s.render.threads_mode='FIXED';s.render.threads=8
...
# Keep the copied master world/light material comparison unchanged.
