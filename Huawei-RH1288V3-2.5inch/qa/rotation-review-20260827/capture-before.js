async (page) => {
  const base = 'http://127.0.0.1:8876/Huawei-RH1288V3-2.5inch';
  const output = '/root/Project/rack-device-3d/Huawei-RH1288V3-2.5inch/qa/rotation-review-20260827/before';
  const viewerPages = {
  ...
  const models = {
    standard: base + '/model/Huawei-RH1288V3-2.5inch.glb',
    web: base + '/model/Huawei-RH1288V3-2.5inch-web.glb'
  };
  const manifest = { device: 'Huawei-RH1288V3-2.5inch', phase: 'before', capturedAt: new Date().toISOString(), yawStepDegrees: 5, yawFrameCountPerCombination: 72, pitchAnglesDegrees: [-35,-20,20,35], pitchYawAnchorsDegrees: [0,90,180,270], combinations: [] };
