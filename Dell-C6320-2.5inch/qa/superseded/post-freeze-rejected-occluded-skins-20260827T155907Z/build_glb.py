...
def build(variant):
    ...
    b.plane("Rear_SourceLocked_Texture",photos["rear"],[(X_BODY,-Y_OUTER,-Z_OUTER+.40),(-X_BODY,-Y_OUTER,-Z_OUTER+.40),(-X_BODY,Y_OUTER,-Z_OUTER+.40),(X_BODY,Y_OUTER,-Z_OUTER+.40)],(0,0,-1),uvs,{"source_lock":"rear","role":"binding real-photograph appearance skin","clearance_mm":.30})
    ...
    for row,yc in enumerate(row_centers,1):
        for col,xc in enumerate(node_centers_x,1):
            ...
            b.box(p+"_PerimeterTop",silver,(xc,yc+18,-Z_OUTER+.80),(177,3,.2),{"node_model":"PowerEdge C6320","not_c6320p":True,"behind_source_photo":True})
            b.box(p+"_PCIeCarrier",silver,(xc-22,yc+7,-Z_OUTER+.80),(128,18,.2),{"slot":"low-profile PCIe/blank","behind_source_photo":True})
            b.box(p+"_PCIeVent",dark,(xc-35,yc+7,-Z_OUTER+.65),(86,12,.1),{"behind_source_photo":True})
            ...
            for label,dx,mat,size in ports:
                b.box(f"{p}_{label}",mat,(xc+dx,yc-11,-Z_OUTER+.80),(size[0],size[1],.2),{"node":node,"port":label,"behind_source_photo":True})
            b.cylinder(p+"_PowerLED",green,(xc+72,yc-11,-Z_OUTER+.003),(3,3,.006))
            b.box(p+"_PullTab",black,(xc+82,yc+5,-Z_OUTER+.80),(13,25,.2),{"node":node,"label":"POWEREDGE C6320","behind_source_photo":True})
    ...
    for index,yc in enumerate((21,-21),1):
        ...
        b.box(p+"_Face",silver,(190,yc,-Z_OUTER+.80),(66,39,.2),{"power_input":"AC","rating_w":1400,"matched_pair":True,"behind_source_photo":True})
        ...
        b.box(p+"_HandleRecess",dark,(184,yc,-Z_OUTER+.75),(7,22,.1),{"behind_source_photo":True})
