...
function buildVariant(textureDir, outputName, variant) {
  ...
  for (let i = 0; i < 18; i++) {
    box(`Top_Rear_Vent_Cell_${String(i+1).padStart(2,'0')}`, mat.black, [-0.160+i*0.019,0.0211,-0.217], [0.011,0.0004,0.020], { category:'top-rear-vent-cell', appearanceSkinClearanceMm:0.2 });
  }
