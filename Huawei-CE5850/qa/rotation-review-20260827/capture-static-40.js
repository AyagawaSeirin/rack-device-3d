async (page) => {
  const base='http://127.0.0.1:8876/Huawei-CE5850',output='/root/Project/rack-device-3d/Huawei-CE5850/qa/rotation-review-20260827/static-40-loads';
  ...
  const models={standard:base+'/model/Huawei-CE5850-48T4S2Q-EI-B00.glb',web:base+'/model/Huawei-CE5850-48T4S2Q-EI-B00-web.glb'};
  ...
  const manifest={device:'Huawei-CE5850',phase:'final-static-40-loads',capturedAt:new Date().toISOString(),views:[],loadCount:0};
